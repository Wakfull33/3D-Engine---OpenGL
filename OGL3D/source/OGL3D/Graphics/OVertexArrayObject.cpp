...
{
    if(!vbDesc.listSize) OGL3D_ERROR("OVertextArrayObject | listSize is NULL");
    if(!vbDesc.vertexSize) OGL3D_ERROR("OVertextArrayObject | vertexSize is NULL");
    if(!vbDesc.verticesList) OGL3D_ERROR("OVertextArrayObject | verticesList is NULL");
...
{
    if(!ibDesc.listSize) OGL3D_ERROR("OVertextArrayObject | listSize is NULL");
    if(!ibDesc.indicesList) OGL3D_ERROR("OVertextArrayObject | indicesList is NULL");
